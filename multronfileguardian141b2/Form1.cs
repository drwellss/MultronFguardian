...
namespace multronfileguardian
{
    public partial class Form1 : Form
    {
        ...
        string mfgciphmod = Application.StartupPath + "\\mfgsettings" + "\\salgcmode.txt";
        ...
        private void getsettings()
        {
            ...
            if (System.IO.Directory.Exists(mfgsfolder))
            {
                ...
                if (formuc.savealgorithm1.Checked == true)
                {
                    ...
                    if (System.IO.File.Exists(mfgciphmod) == true)
                    {
                        string algorithm = System.IO.File.ReadAllText(mfgciphmod);
                        short ty = 0;
        ...
        public void savesettings()
        {
            ...
            if (formuc.savealgorithm1.Checked == true)
            {
                ...
                System.IO.File.WriteAllText(mfgciphmod, comboBox4.Text);
            }
            if (formuc.iterationaut1.Checked == true)
            {
            ...
            try {
                ...
                foreach (string dosyalar in listBox1.Items)
                {
                    ...
                    else
                    {
                        ...
                        rijndael.Key = new System.Security.Cryptography.Rfc2898DeriveBytes(aeskey, System.Text.Encoding.ASCII.GetBytes("youcanjoinsaltinfutureversionsmsmsms"), iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes(symkeysize / 8);
                        rijndael.IV = ivtg;
                        long seekpoint = okur.BaseStream.Position;
                        if (comboBox4.Text == "Encrypt-then-MAC")
                        {
                            okur.Close();
                        }
                        ...
                        if (comboBox4.Text == "Encrypt-then-MAC")
                        {
                            ...
                            BinaryReader breader = new BinaryReader(System.IO.File.Open(dosyalar, FileMode.Open, FileAccess.Read));
                            long filesizse = new FileInfo(dosyalar).Length - 64;
                            breader.BaseStream.Position = seekpoint - 16;
                            byte[] fbytes = new byte[1000000];
                            byte[] hashbytes = null;
                            while (breader.BaseStream.Position < filesizse)
                            {
                                long ssswherweare = filesizse - breader.BaseStream.Position;
                            ...
                            foreach (byte b in hashbytesif)
                            {
                                ...
                                {
                                    authcode = 0;
                                    MessageBox.Show(dosyalar + " file cannot be authenticated, Decryption denied!   ", "Multron File Guardian", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                    break;
                                }
                                ++bcount;
                            }
                        ...
                        if (comboBox4.Text == "Encrypt-then-MAC")
                        {
                            ...
                            okur = new System.IO.BinaryReader(System.IO.File.Open(dosyalar, System.IO.FileMode.Open, System.IO.FileAccess.Read));
                            okur.BaseStream.Position = seekpoint;
            ...
            try
            {
                ...
                foreach (string dosyalar in listBox1.Items)
                {
                    ...
                    if (encryptstatus != 1 && comboBox4.Text == "Encrypt-then-MAC")
                    {
                        label4.Text = "Authenticating...";
                        BinaryReader breader = new BinaryReader(System.IO.File.Open(dosyalar, FileMode.Open, FileAccess.Read));
                        long filesize = new FileInfo(dosyalar).Length - 64;
                        byte[] fbytes = new byte[1000000];
                        byte[] hashbytes = null;
                    ...
                    if (comboBox4.Text == "Encrypt-then-MAC" && encryptstatus != 1)
                    {
                        fsize = fsize - 64;
                    }
                    string filenamew = new System.IO.FileInfo(dosyalar).Name;
                    while (okur.BaseStream.Position < fsize)
                    {
                        ...
                        if (whereweare > 1000000)
                        {
                            ...
                            if (comboBox4.Text == "Encrypt-then-MAC" && encryptstatus == 1)
                            {
                                hsha512.TransformBlock(encdata, 0, 1000000, null, 0);
                            }
            ...
            try
            {
                ...
                foreach (string dosyalar in listBox1.Items)
                {
                    if (encryptstatus == 1)
                    {
                        ...
                        label4.Text = "Iterating Password...";
                        ivtg = new System.Security.Cryptography.Rfc2898DeriveBytes(reversebarray(raes.generaterandomkey(67)), System.Text.Encoding.ASCII.GetBytes(reversestring("youcanjoinsaltinfutureversivonsmsmsms")), 143, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes(12);
                        byte[] chrsakey = new System.Security.Cryptography.Rfc2898DeriveBytes(serpentkey, System.Text.Encoding.ASCII.GetBytes("youcanjoinsaltinfutureversionsmsmsms"), iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes(32);
                        sifreler.Init(true, new ParametersWithIV(new KeyParameter(chrsakey), ivtg));
                        okur = new BinaryReader(File.Open(dosyalar, FileMode.Open, FileAccess.Read));
                        yazar = new BinaryWriter(File.Open(dosyalar + ".mfg", FileMode.Create, FileAccess.Write));
                        ...
                        if (comboBox4.Text == "Encrypt-then-MAC")
                        {
                            hsha512 = new HMACSHA512(new System.Security.Cryptography.Rfc2898DeriveBytes(reversebarray(chrsakey), System.Text.Encoding.ASCII.GetBytes("youcanamacsjugjoinsaltinfutureversionsmsmsms"), 5000, System.Security.Cryptography.HashAlgorithmName.SHA384).GetBytes(128));
                            hsha512.TransformBlock(ivtg, 0, 12, null, 0);
                        }
                    ...
                    else
                    {
                        ...
                        label4.Text = "Iterating Password...";
                        byte[] chrsakh = new System.Security.Cryptography.Rfc2898DeriveBytes(dsk, System.Text.Encoding.ASCII.GetBytes("youcanjoinsaltinfutureversionsmsmsms"), iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes(32);
                        long seekpoint = okur.BaseStream.Position;
                        if (comboBox4.Text == "Encrypt-then-MAC")
                        {
                            okur.Close();
                             hsha512 = new HMACSHA512(new System.Security.Cryptography.Rfc2898DeriveBytes(reversebarray(chrsakh), System.Text.Encoding.ASCII.GetBytes("youcanamacsjugjoinsaltinfutureversionsmsmsms"), 5000, System.Security.Cryptography.HashAlgorithmName.SHA384).GetBytes(128));
                            label4.Text = "Authenticating...";
                            BinaryReader breader = new BinaryReader(System.IO.File.Open(dosyalar, FileMode.Open, FileAccess.Read));
                            long filesizse = new FileInfo(dosyalar).Length - 64;
                            breader.BaseStream.Position = seekpoint - 12;
                            byte[] fbytes = new byte[1000000];
                            byte[] hashbytes = null;
                            while (breader.BaseStream.Position < filesizse)
                            {
                        ...
                        sifreler.Init(false, new ParametersWithIV(new KeyParameter(chrsakh), ivtg));
                        dsk = new byte[] { 0 };
                        chrsakh = new byte[] { 0 };
        ...
        public void bciphersrsaprocesses(string key, IBlockCipher bc, short blocksize = 16)
        {
            ...
            try
            {
                ...
                foreach (string dosyalar in listBox1.Items)
                {
                    if (encryptstatus == 1)
                    {
                        ...
                        byte[] pasbarray = new System.Security.Cryptography.Rfc2898DeriveBytes(serpentkey, System.Text.Encoding.ASCII.GetBytes("youcanjoinsaltinfutureversionsmsmsms"), iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes(symkeysize / 8);
                        sifreler.Init(true, new ParametersWithIV(new KeyParameter(pasbarray), ivtg));
                        hsha512 = new HMACSHA512(new System.Security.Cryptography.Rfc2898DeriveBytes(reversebarray(pasbarray), System.Text.Encoding.ASCII.GetBytes("youcanamacsjugjoinsaltinfutureversionsmsmsms"), 5000, System.Security.Cryptography.HashAlgorithmName.SHA384).GetBytes(128));
                        okur = new BinaryReader(File.Open(dosyalar, FileMode.Open, FileAccess.Read));
                        yazar = new BinaryWriter(File.Open(dosyalar + ".mfg", FileMode.Create, FileAccess.Write));
                        yazar.Write(serkey, 0, keysize / 8);
                        yazar.Write(ivtg);
                        pasbarray = new byte[] { 0 };
                        if (comboBox4.Text == "Encrypt-then-MAC")
                        {
                    ...
                    else
                    {
                        ...
                        label4.Text = "Iterating Password...";
                        long seekpoint = okur.BaseStream.Position;
                        byte[] cphkeyrsa = new System.Security.Cryptography.Rfc2898DeriveBytes(dsk, System.Text.Encoding.ASCII.GetBytes("youcanjoinsaltinfutureversionsmsmsms"), iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes(symkeysize / 8);
                        if (comboBox4.Text == "Encrypt-then-MAC")
                        {
                            okur.Close();
                            hsha512 = new HMACSHA512(new System.Security.Cryptography.Rfc2898DeriveBytes(reversebarray(cphkeyrsa), System.Text.Encoding.ASCII.GetBytes("youcanamacsjugjoinsaltinfutureversionsmsmsms"), 5000, System.Security.Cryptography.HashAlgorithmName.SHA384).GetBytes(128));
                            label4.Text = "Authenticating...";
                            BinaryReader breader = new BinaryReader(System.IO.File.Open(dosyalar, FileMode.Open, FileAccess.Read));
                            long filesizse = new FileInfo(dosyalar).Length - 64;
                            breader.BaseStream.Position = seekpoint - blocksize;
                            byte[] fbytes = new byte[1000000];
                            byte[] hashbytes = null;
                            while (breader.BaseStream.Position < filesizse)
                            {
                        ...
                        sifreler.Init(false, new ParametersWithIV(new KeyParameter(cphkeyrsa), ivtg));
                        dsk = new byte[] { 0 };
                        cphkeyrsa = new byte[] { 0 };
                        byte[] bynetx = new byte[1000000];
                        long fsize = new System.IO.FileInfo(dosyalar).Length;
                        if (comboBox4.Text == "Encrypt-then-MAC")
                        {
            ...
            {
                nstate = 0;
                MessageBox.Show("Operation ended with a error, these may cause an error's occure: file dont exists, program haven't access to file, your password is wrong or something else, error = " + ex.Message + ex.StackTrace + " | You can contact programmer, Discord = dr_wellss", "Multron File Guardian", MessageBoxButtons.OK, MessageBoxIcon.Error);
                try
                {
                    if (okur != null)
                    {
        ...
        public void compressionoperationwithzip()
        {
            ...
            try
            {
                if (encryptstatus == 1)
                {
                    string oputzipf = textBox2.Text + "\\" + raes.getrandomstring(24) + ".zip";
        ...
        {
            MessageBox.Show("This option provide authenticated encryption, Encrypt-then-MAC mode recommended against unauthorized changes", "Multron File Guardian", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
