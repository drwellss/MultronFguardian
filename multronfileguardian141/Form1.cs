        ...
        public void chachaprocesses(string key)
        {
            ...
            try
            {
                ...
                if (encryptstatus == 1)
                {
                    ...
                    keyt = new System.Security.Cryptography.Rfc2898DeriveBytes(key, seasalt, iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes(32);
                }
                else
                {
                    cryptstate = false;
