            ...
            try {
                ...
                foreach (string dosyalar in listBox1.Items)
                {
                    ...
                    if (encryptstatus == 1)
                    {
                        ...
                        {
                            byte[] scrkey = new System.Security.Cryptography.Rfc2898DeriveBytes(aeskey, System.Text.Encoding.ASCII.GetBytes("youcanjoinsaltinfutureversionsmsmsms").Concat(System.Text.Encoding.ASCII.GetBytes(comboBox1.Text + "-" + comboBox3.Text)).ToArray(), iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes((symkeysize / 8) * 2);
                        ...
                        {
                            byte[] serpkey = new System.Security.Cryptography.Rfc2898DeriveBytes(aeskey, System.Text.Encoding.ASCII.GetBytes("youcanjoinsaltinfutureversionsmsmsms"), iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes(symkeysize / 8);
                            aeskey = serpkey;
                            serpkey = new byte[] { 0 };
                        }
                    ...
                    else
                    {
                        ...
                        {
                            byte[] adsk = new System.Security.Cryptography.Rfc2898DeriveBytes(aeskey, System.Text.Encoding.ASCII.GetBytes("youcanjoinsaltinfutureversionsmsmsms"), iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes(symkeysize / 8);
                            aeskey = adsk;
                            adsk = new byte[] { 0 };
                        }
            ...
            try
            {
                ...
                foreach (string dosyalar in listBox1.Items)
                {
                    ...
                    if (encryptstatus == 1)
                    {
                        ...
                        if (comboBox4.Text == "Encrypt-then-MAC")
                        {
                            byte[] scrkey = new System.Security.Cryptography.Rfc2898DeriveBytes(key, seasalt.Concat(System.Text.Encoding.ASCII.GetBytes(comboBox1.Text + "-" + comboBox3.Text)).ToArray(), iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes((symkeysize / 8) * 2);
                            hsha512 = new HMACSHA512(scrkey.Skip(scrkey.Length / 2).ToArray());
                        ...
                        {
                            keyt = new System.Security.Cryptography.Rfc2898DeriveBytes(key, seasalt, iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes(symkeysize / 8);
                        }
                        yazar.Write(ivtg);
                    }
                    else
            ...
            try
            {
                ...
                foreach (string dosyalar in listBox1.Items)
                {
                    if (encryptstatus == 1)
                    {
                        ...
                        if (comboBox4.Text == "Encrypt-then-MAC")
                        {
                            byte[] scrkey = new System.Security.Cryptography.Rfc2898DeriveBytes(serpentkey, System.Text.Encoding.ASCII.GetBytes("youcanjoinsaltinfutureversionsmsmsms").Concat(System.Text.Encoding.ASCII.GetBytes(comboBox1.Text + "-" + comboBox3.Text)).ToArray(), iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes((symkeysize / 8) * 2);
                            hsha512 = new HMACSHA512(scrkey.Skip(scrkey.Length / 2).ToArray());
                        ...
                        {
                            byte[] serpkey = new System.Security.Cryptography.Rfc2898DeriveBytes(serpentkey, System.Text.Encoding.ASCII.GetBytes("youcanjoinsaltinfutureversionsmsmsms"), iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes(symkeysize / 8);
                            serpentkey = serpkey;
                            serpkey = new byte[] { 0 };
                        }
                    ...
                    else
                    {
                        ...
                        {
                            label4.Text = "Authentication starting...";
                            byte[] scrkey = new System.Security.Cryptography.Rfc2898DeriveBytes(dsk, System.Text.Encoding.ASCII.GetBytes("youcanjoinsaltinfutureversionsmsmsms").Concat(System.Text.Encoding.ASCII.GetBytes(comboBox1.Text + "-" + comboBox3.Text)).ToArray(), iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes((symkeysize / 8) * 2);
                            hsha512 = new HMACSHA512(scrkey.Skip(scrkey.Length / 2).ToArray());
                        ...
                        {
                            byte[] adsk = new System.Security.Cryptography.Rfc2898DeriveBytes(dsk, System.Text.Encoding.ASCII.GetBytes("youcanjoinsaltinfutureversionsmsmsms"), iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes(symkeysize / 8);
                            dsk = adsk;
                            adsk = new byte[] { 0 };
                        }
                        okur.BaseStream.Position = sposit;
            ...
            try
            {
                ...
                foreach (string dosyalar in listBox1.Items)
                {
                    ...
                    if (encryptstatus == 1)
                    {
                        ...
                        {
                            rijndael.Key = new System.Security.Cryptography.Rfc2898DeriveBytes(key, seasalt, iterationrate, System.Security.Cryptography.HashAlgorithmName.SHA512).GetBytes(symkeysize / 8);
                        }
                        sifreler = new System.Security.Cryptography.CryptoStream(tutar, rijndael.CreateEncryptor(), System.Security.Cryptography.CryptoStreamMode.Write);
                    }
                    else
